...
console.log(isOpen)
  return (
   ...
   <Dialog.Panel className="relative w-full  max-w-full max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white
   text-left shadow-xl transition-all flex flex-col gap-5 p-6
   ">
   <button type='button' onClick={closeModal} className='absolute bg-primary-blue-100 rounded-full top-2 right-2 z-10 w-fit p-2'>
